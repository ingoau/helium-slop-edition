...
REPLACEMENT_REGEXES_STR = [
    ...
    (r'(?:Google )?Chrom(e|ium)(?!\w)', r'Helium Slop Edition'),
...
def replace_text(text):
    """Replaces instances of Chrom(e | ium) with Helium Slop Edition in strings"""
    had_match = False
...
def replace_grit_message(msg):
    """
    Replaces instances of Chrom(e | ium) with Helium Slop Edition
...
def replace_xtb_translation(msg, fp_map):
    """
    Replaces instances of Chrom(e | ium) with Helium Slop Edition in a
    .xtb <translation>.
    """
...
def replace_grit_tree(text):
    """Replaces instances of Chrom(e | ium) with Helium Slop Edition, where desired"""
...
def dedup_translations_in_place(translation, seen):
    ...
    # "Chrome" variant. Since we substituted both of those with Helium Slop Edition,
